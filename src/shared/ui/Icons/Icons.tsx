...
export const TablesIcon: FC<IconProps> = ({ className }) => (
  <svg
    width="28"
    height="28"
    viewBox="0 0 28 28"
  ...
  >
    ...
    <defs>
      <clipPath id="clip0_201_2906">
        <rect width="28" height="28" fill="var(--color-white)" />
      </clipPath>
    </defs>
  </svg>
);

export const KanbanIcon: FC<IconProps> = ({ className }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
export const SigninIcon: FC<IconProps> = ({ className }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
export const EaringIcon: FC = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip0_201_2498)">
      <path
        d="M20.2839 24.3136H20.5576C21.6113 24.3136 22.4734 25.1757 22.4734 26.2293V35.8082C22.4734 36.8618 21.6113 37.7239 20.5576 37.7239H20.2839C19.2303 37.7239 18.3682 36.8618 18.3682 35.8082V26.2293C18.3682 25.1757 19.2303 24.3136 20.2839 24.3136ZM27.947 18.5663C29.0007 18.5663 29.8627 19.4284 29.8627 20.482V35.8082C29.8627 36.8618 29.0007 37.7239 27.947 37.7239C26.8933 37.7239 26.0312 36.8618 26.0312 35.8082V20.482C26.0312 19.4284 26.8933 18.5663 27.947 18.5663ZM35.61 29.5135C36.6637 29.5135 37.5258 30.3756 37.5258 31.4293V35.8082C37.5258 36.8618 36.6637 37.7239 35.61 37.7239C34.5564 37.7239 33.6943 36.8618 33.6943 35.8082V31.4293C33.6943 30.3756 34.5564 29.5135 35.61 29.5135Z"
        fill="var(--color-deep-blue)"
      />
    </g>
    <defs>
      <clipPath id="clip0_201_2498">
        <rect
          width="32.8417"
          height="32.8417"
          fill="white"
...
export const SpendIcon: FC = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip0_201_2510)">
      <path
        d="M27.6734 26.6398C24.5672 25.8325 23.5682 24.9978 23.5682 23.6978C23.5682 22.2062 24.9503 21.1662 27.2629 21.1662C29.206 21.1662 30.1776 21.9052 30.5334 23.082C30.6976 23.6294 31.1492 24.0399 31.7239 24.0399H32.1344C33.0376 24.0399 33.6807 23.1504 33.366 22.302C32.7913 20.6873 31.4502 19.3463 29.3155 18.8263V17.8821C29.3155 16.7463 28.3987 15.8295 27.2629 15.8295C26.1271 15.8295 25.2103 16.7463 25.2103 17.8821V18.7852C22.5556 19.3599 20.4209 21.0841 20.4209 23.7252C20.4209 26.8862 23.0345 28.4598 26.8524 29.3767C30.2734 30.1977 30.9576 31.4019 30.9576 32.6745C30.9576 33.6187 30.2871 35.1239 27.2629 35.1239C25.005 35.1239 23.8419 34.3166 23.3903 33.1671C23.1851 32.6335 22.7198 32.2503 22.1588 32.2503H21.7756C20.8588 32.2503 20.2156 33.1808 20.5577 34.0292C21.3377 35.9313 23.1577 37.0534 25.2103 37.4913V38.4081C25.2103 39.5439 26.1271 40.4607 27.2629 40.4607C28.3987 40.4607 29.3155 39.5439 29.3155 38.4081V37.5187C31.9839 37.0123 34.1049 35.466 34.1049 32.6608C34.1049 28.7746 30.7797 27.4472 27.6734 26.6398Z"
        fill="var(--color-deep-blue)"
      />
    </g>
    <defs>
      <clipPath id="clip0_201_2510">
        <rect
          width="32.8417"
          height="32.8417"
          fill="white"
...
export const TasksIcon: FC = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip0_201_1824)">
      <path
        d="M39.6663 20.0434L26.3547 33.3667L21.408 28.42L23.053 26.775L26.3547 30.0767L38.0213 18.41L39.6663 20.0434ZM27.9997 37.3334C22.8547 37.3334 18.6663 33.145 18.6663 28C18.6663 22.855 22.8547 18.6667 27.9997 18.6667C29.8313 18.6667 31.5463 19.2034 32.993 20.125L34.6847 18.4334C32.783 17.115 30.4847 16.3334 27.9997 16.3334C21.5597 16.3334 16.333 21.56 16.333 28C16.333 34.44 21.5597 39.6667 27.9997 39.6667C30.018 39.6667 31.9197 39.1534 33.5763 38.2434L31.8263 36.4934C30.6597 37.03 29.3647 37.3334 27.9997 37.3334ZM36.1663 31.5H32.6663V33.8334H36.1663V37.3334H38.4997V33.8334H41.9997V31.5H38.4997V28H36.1663V31.5Z"
        fill="white"
      />
    </g>
    <defs>
      <linearGradient
        id="paint0_linear_201_1824"
        x1="0"
        y1="28"
        x2="56"
        y2="28"
      ...
      >
        <stop stopColor="var(--color-light-blue-icon)" />
...
export const ProjectsIcon: FC = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip0_201_1831)">
      <path
        d="M31.2503 16.0833H19.3337C18.142 16.0833 17.167 17.0583 17.167 18.25V32.3333C17.167 32.9291 17.6545 33.4166 18.2503 33.4166C18.8462 33.4166 19.3337 32.9291 19.3337 32.3333V19.3333C19.3337 18.7375 19.8212 18.25 20.417 18.25H31.2503C31.8462 18.25 32.3337 17.7625 32.3337 17.1666C32.3337 16.5708 31.8462 16.0833 31.2503 16.0833ZM31.8895 21.0558L37.122 26.2883C37.5228 26.6891 37.7503 27.2416 37.7503 27.8158V37.75C37.7503 38.9417 36.7753 39.9166 35.5837 39.9166H23.6562C22.4645 39.9166 21.5003 38.9417 21.5003 37.75L21.5112 22.5833C21.5112 21.3916 22.4753 20.4166 23.667 20.4166H30.3512C30.9253 20.4166 31.4778 20.6441 31.8895 21.0558ZM31.2503 28H36.1253L30.167 22.0416V26.9166C30.167 27.5125 30.6545 28 31.2503 28Z"
        fill="var(--color-deep-blue)"
      />
    </g>
    <defs>
    ...
    <g filter="url(#filter0_ddii_3_2)">
      <g clipPath="url(#clip0_3_2)">
        ...
        <path
          ...
          fill="var(--color-light-white-icon-tertiary)"
          fillOpacity="0.91"
        />
      </g>
    </g>
    ...
    <g filter="url(#filter0_ddii_3_129)">
      <g clipPath="url(#clip0_3_129)">
        ...
        <path
          ...
          fill="var(--color-light-white-icon-fourth)"
        />
      </g>
    </g>
    <defs>
